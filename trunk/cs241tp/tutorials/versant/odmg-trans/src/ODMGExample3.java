...
public class ODMGExample3 {
  ...
  public static void main (String[] args) {
    ...
    if (args.length  < 2) {
      System.err.println ("Usage: java ODMGExample3 <dbname1> <dbname2>");
      System.exit (1);
    }

    System.out.println ("ODMGExample3");
    ...
    // spawn a new thread
    ODMGThread3 secondThread = new ODMGThread3 (txact, args[1], db);
    secondThread.start ();
    ...
    try {
      ...
      retrieveP[2] = (Person) db.lookup ("Root-Person-Th2");
      System.out.println ("Retrieved \"Root-Person-Th2\": " + retrieveP[2]);
      retrieveP[3] = (Person) db.lookup ("Root-Person-Th3");
      System.out.println ("Retrieved \"Root-Person-Th3\": " + retrieveP[3]);
    }  catch (ODMGException e) {
    ...
    try {
      retrieveP[4] = (Person) secondThread.threadDb.lookup ("Root-Person-Th1");
      System.out.println ("Retrieved \"Root-Person-Th1\": " + retrieveP[4]);
    }  catch (ODMGException e) {
      System.err.println ("Exception in Database lookup (): " + e);
      e.printStackTrace ();
      System.exit (1);
