...
public class MemoryMngmt
{
	...
	public static void main (String[] args)
	{
    	if (args.length < 1)
    	{
       		System.out.println ("Usage: MemoryMngmt <db> ");
        	System.exit (-1);
   	 	}
		...
		/*releaseObjects() Immediately releases the memory space used by the objects in this vector.
		Alternatives for the pinning options parameters are:
		0 Release all objects.
		Constants.SKIP_NEW
		Constants.SKIP_DIRTY
		Present int the class HandleVector */
		...
		System.out.println("After using releaseObjects()\n");
 		System.out.println("FreeSpace:  "+free);
		System.out.println("MaximumSpace: "+max);
		System.out.println("Percentage Of FreeSpace: "+percent);
