/**
 * Cache' Java Class Generated for class JavaTutorial.PhoneNumber
 *
 *
**/
...
public class PhoneNumber extends Persistent {

    private static String CACHE_CLASS_NAME = "JavaTutorial.PhoneNumber";
    /**
           NB: DO NOT USE IN APPLICATION!
           Use <code>PhoneNumber._open</code> instead.
           <p>
    ...
    */
    public PhoneNumber (CacheObject ref) throws CacheException {
        super (ref);
    }
    /**
       ...
       @throws CacheException in case of error.
              ...
              @see #_open(com.intersys.objects.Database, com.intersys.objects.Id)
     */
    public PhoneNumber (Database db) throws CacheException {
    ...
    /**
       ...
       object. This object may be of <code>PhoneNumber</code> or of
      any of its subclasses. Cast to <code>PhoneNumber</code> is
    ...
    /**
      ...
      @see java.lang.ClassCastException
           @see #_open(com.intersys.objects.Database, com.intersys.objects.Id)
           @see #PhoneNumber(com.intersys.objects.Database)
     */
    ...
    /**
       Returns class name of the class PhoneNumber as it is in
   ...
   */
    ...
    public static void checkAllFieldsValid(Database db ) throws CacheException {
        checkAllFieldsValid(db, CACHE_CLASS_NAME, PhoneNumber.class);
    }
    ...
    public static void checkAllMethods(Database db ) throws CacheException {
        checkAllMethods(db, CACHE_CLASS_NAME, PhoneNumber.class);
    }
    private static int ii_Contact = 4;
    private static int jj_Contact = 0;
    private static int kk_Contact = 3;
    /**
       Verifies that indexes for property <code>Contact</code> in
       zObjVal are the same as in Cache. It does not return anything
       but it throws an exception in case of inconsistency.
     ...
     */
    public static void checkContactValid (Database db) throws CacheException {
        checkZobjValid(db, CACHE_CLASS_NAME, "Contact",ii_Contact, jj_Contact, kk_Contact);
    }
    /**
       Returns value of property <code>Contact</code>
       @return current value of <code>Contact</code> represented as
       <code>JavaTutorial.Contact</code>

       @throws CacheException if any error occurred during value retrieval.

    */
    public JavaTutorial.Contact getContact() throws CacheException {
        Dataholder dh = mInternal.getProperty(ii_Contact,
                                                jj_Contact,
                                                Database.RET_OBJECT,
                                                "Contact");
        ...
        if (cobj == null)
            return null;
        return (JavaTutorial.Contact)(cobj.newJavaInstance());
    }
    ...
    */
    public void setContact(JavaTutorial.Contact value) throws CacheException {
        Dataholder dh = new Dataholder (value);
        mInternal.setProperty(ii_Contact, jj_Contact,kk_Contact, Database.RET_OBJECT, "Contact", dh);
        return;
    }

    private static int ii_Number = 5;
    private static int jj_Number = 0;
    private static int kk_Number = 4;
    /**
     ...
     */
    public static void checkNumberValid (Database db) throws CacheException {
    ...
    */
    public java.lang.String getNumber() throws CacheException {
        Dataholder dh = mInternal.getProperty(ii_Number,
                                                jj_Number,
                                                Database.RET_PRIM,
                                                "Number");
       return dh.getString();
    ...
    */
    public void setNumber(java.lang.String value) throws CacheException {
        Dataholder dh = new Dataholder (value);
        mInternal.setProperty(ii_Number, jj_Number,kk_Number, Database.RET_PRIM, "Number", dh);
        return;
    }

    private static int ii_PhoneNumberType = 6;
    private static int jj_PhoneNumberType = 0;
    private static int kk_PhoneNumberType = 5;
    /**
       Verifies that indexes for property <code>PhoneNumberType</code> in
       zObjVal are the same as in Cache. It does not return anything
       but it throws an exception in case of inconsistency.
     ...
     */
    public static void checkPhoneNumberTypeValid (Database db) throws CacheException {
        checkZobjValid(db, CACHE_CLASS_NAME, "PhoneNumberType",ii_PhoneNumberType, jj_PhoneNumberType, kk_PhoneNumberType);
    }
    /**
       Returns value of property <code>PhoneNumberType</code>
       @return current value of <code>PhoneNumberType</code> represented as
       <code>java.lang.String</code>

       @throws CacheException if any error occurred during value retrieval.

    */
    public java.lang.String getPhoneNumberType() throws CacheException {
        Dataholder dh = mInternal.getProperty(ii_PhoneNumberType,
                                                jj_PhoneNumberType,
                                                Database.RET_PRIM,
                                                "PhoneNumberType");
       return dh.getString();
    ...
    /**
       Sets new value for <code>PhoneNumberType</code>.
       @param value new value to be set represented as
       <code>java.lang.String</code>.
       @throws CacheException if any error occurred during value setting.

    */
    public void setPhoneNumberType(java.lang.String value) throws CacheException {
        Dataholder dh = new Dataholder (value);
        mInternal.setProperty(ii_PhoneNumberType, jj_PhoneNumberType,kk_PhoneNumberType, Database.RET_PRIM, "PhoneNumberType", dh);
        return;
    }
    ...
    */
    ...
    public static CacheQuery query_Extent (Database db) throws CacheException {
        return new CacheQuery(db, "JavaTutorial.PhoneNumber_Extent", 0, 0);
    }

    public static CacheQuery query_RetrieveByContactName (Database db) throws CacheException {
        return new CacheQuery(db, "JavaTutorial.PhoneNumber_RetrieveByContactName", 1, 2);
    }
